...
from snippetTest.views import loginView, homeView, submitLogout, deleteSnippet, viewSnippets, editSnippet, openSnippet, uploadView
...
urlpatterns = [
    ...
    path('searchSnippets/', viewSnippets),
